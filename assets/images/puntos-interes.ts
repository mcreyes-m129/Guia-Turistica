...
export const puntosDeInteres: PuntoInteres[] = [
  {
    ...
    duracionSugerida: '35 a 60 minutos',
  ...
  },
  {
    ...
    ubicacion: { lat: -28.456534915256995, lng: -65.80925020426662 },
    imagenes: ['/assets/images/jumeal.webp'],
  },
  {
    id: '3',
    nombre: 'Cuesta del Portezuelo',
    descripcion: 'Mirador panorámico con vistas increibles del Valle.',
    ...
    ubicacion: { lat: -28.489095142602974, lng: -65.60619312574956 },
